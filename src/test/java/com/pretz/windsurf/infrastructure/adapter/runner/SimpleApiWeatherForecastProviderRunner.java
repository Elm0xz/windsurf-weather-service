...
import com.pretz.windsurf.infrastructure.adapter.outbound.api.WeatherForecastProvider;
...
class SimpleApiWeatherForecastProviderRunner {
    ...
    static void main(String[] args) {
        ...
        Cache<LocalDate, List<Forecast>> cache = Caffeine.newBuilder()
                .expireAfterWrite(Duration.ofHours(12))
                .build();
        try (WeatherForecastProvider provider = new WeatherForecastProvider(
                new WeatherbitApiClient(client, apiKey, forecastDays, forecastPath, new WeatherbitApiValidator()), cache, 5)) {
